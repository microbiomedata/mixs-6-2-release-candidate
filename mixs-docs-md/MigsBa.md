...
URI: [mixs_6_2_proposal:MigsBa](https://turbomam.github.io/mixs-envo-struct-knowl-extraction/MigsBa)
...
```mermaid
 classDiagram
    class MigsBa
      ...
      MigsBa : assembly_name
        
      MigsBa : assembly_qual
        
      MigsBa : assembly_software
        
      MigsBa : associated_resource
        
      MigsBa : biotic_relationship
        
          MigsBa --|> BIOTIC_RELATIONSHIP_ENUM : biotic_relationship
        
      MigsBa : collection_date
        
      MigsBa : compl_score
        
      MigsBa : compl_software
        
      MigsBa : depth
        
      MigsBa : elev
        
      MigsBa : encoded_traits
        
      MigsBa : env_broad_scale
        
      MigsBa : env_local_scale
        
      MigsBa : env_medium
        
      MigsBa : estimated_size
        
      MigsBa : experimental_factor
        
      MigsBa : extrachrom_elements
        
      MigsBa : feat_pred
        
      MigsBa : geo_loc_name
        
      MigsBa : host_disease_stat
        
      MigsBa : host_spec_range
        
      MigsBa : isol_growth_condt
        
      MigsBa : lat_lon
        
      MigsBa : lib_layout
        
          MigsBa --|> LIB_LAYOUT_ENUM : lib_layout
        
      MigsBa : lib_reads_seqd
      ...
      MigsBa : neg_cont_type
        
          MigsBa --|> NEG_CONT_TYPE_ENUM : neg_cont_type
        
      MigsBa : nucl_acid_amp
        
      MigsBa : nucl_acid_ext
        
      MigsBa : num_replicons
        
      MigsBa : number_contig
        
      MigsBa : pathogenicity
        
      MigsBa : pos_cont_type
        
      MigsBa : project_name
        
      MigsBa : ref_biomaterial
        
      MigsBa : ref_db
        
      MigsBa : rel_to_oxygen
        
          MigsBa --|> REL_TO_OXYGEN_ENUM : rel_to_oxygen
        
      MigsBa : samp_collect_device
        
      MigsBa : samp_collect_method
        
      MigsBa : samp_mat_process
        
      MigsBa : samp_name
        
      MigsBa : samp_size
        
      MigsBa : samp_taxon_id
        
      MigsBa : samp_vol_we_dna_ext
        
      MigsBa : seq_meth
        
      MigsBa : sim_search_meth
        
      MigsBa : sop
        
      MigsBa : source_mat_id
        
      MigsBa : specific_host
        
      MigsBa : subspecf_gen_lin
        
      MigsBa : tax_class
        
      MigsBa : tax_ident
        
          MigsBa --|> TAX_IDENT_ENUM : tax_ident
        
      MigsBa : temp
        
      MigsBa : trophic_level
        
          MigsBa --|> TROPHIC_LEVEL_ENUM : trophic_level
...
| [extrachrom_elements](extrachrom_elements.md) | 0..1 _recommended_ <br/> [Integer](Integer.md) | Do plasmids exist of significant phenotypic consequence (e | direct |
...
| [num_replicons](num_replicons.md) | 1..1 <br/> [Integer](Integer.md) | Reports the number of replicons in a nuclear genome of eukaryotes, in the gen... | direct |
...
| [encoded_traits](encoded_traits.md) | 0..1 <br/> [String](String.md) | Should include key traits like antibiotic resistance or xenobiotic degradatio... | direct |
...
| [ref_biomaterial](ref_biomaterial.md) | 1..1 <br/> [String](String.md) | Primary publication if isolated before genome publication; otherwise, primary... | direct |
...
| ---  | ---  |
| self | mixs_6_2_proposal:MigsBa |
| native | mixs_6_2_proposal:MigsBa |

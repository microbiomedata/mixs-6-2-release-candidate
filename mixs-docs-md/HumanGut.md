...
URI: [mixs_6_2_proposal:HumanGut](https://turbomam.github.io/mixs-envo-struct-knowl-extraction/HumanGut)
...
```mermaid
 classDiagram
    class HumanGut
      ...
      HumanGut : chem_administration
        
      HumanGut : ethnicity
        
      HumanGut : gastrointest_disord
        
      HumanGut : host_age
        
      HumanGut : host_body_mass_index
        
      HumanGut : host_body_product
        
      HumanGut : host_body_site
        
      HumanGut : host_body_temp
        
      HumanGut : host_diet
        
      HumanGut : host_disease_stat
        
      HumanGut : host_fam_rel
        
      HumanGut : host_genotype
        
      HumanGut : host_height
        
      HumanGut : host_last_meal
        
      HumanGut : host_occupation
        
      HumanGut : host_phenotype
        
      HumanGut : host_pulse
        
      HumanGut : host_sex
        
          HumanGut --|> HOST_SEX_ENUM : host_sex
        
      HumanGut : host_subject_id
        
      HumanGut : host_symbiont
        
      HumanGut : host_tot_mass
        
      HumanGut : ihmc_medication_code
        
      HumanGut : liver_disord
        
      HumanGut : medic_hist_perform
        
      HumanGut : misc_param
        
      HumanGut : organism_count
        
      HumanGut : oxy_stat_samp
        
          HumanGut --|> OXY_STAT_SAMP_ENUM : oxy_stat_samp
        
      HumanGut : perturbation
        
      HumanGut : project_name
        
      HumanGut : salinity
        
      HumanGut : samp_name
        
      HumanGut : samp_store_dur
        
      HumanGut : samp_store_loc
        
      HumanGut : samp_store_temp
        
      HumanGut : samp_vol_we_dna_ext
        
      HumanGut : special_diet
...
| [gastrointest_disord](gastrointest_disord.md) | 0..* <br/> [String](String.md) | History of gastrointestinal tract disorders; can include multiple disorders | direct |
| [liver_disord](liver_disord.md) | 0..* <br/> [String](String.md) | History of liver disorders; can include multiple disorders | direct |
| [special_diet](special_diet.md) | 0..* <br/> [String](String.md) | Specification of special diet; can include multiple special diets | direct |
...
| ---  | ---  |
| self | mixs_6_2_proposal:HumanGut |
| native | mixs_6_2_proposal:HumanGut |

...
URI: [mixs_6_2_proposal:MigsOrg](https://turbomam.github.io/mixs-envo-struct-knowl-extraction/MigsOrg)
...
```mermaid
 classDiagram
    class MigsOrg
      ...
      MigsOrg : assembly_name
        
      MigsOrg : assembly_qual
        
      MigsOrg : assembly_software
        
      MigsOrg : associated_resource
        
      MigsOrg : collection_date
        
      MigsOrg : compl_score
        
      MigsOrg : compl_software
        
      MigsOrg : depth
        
      MigsOrg : elev
        
      MigsOrg : env_broad_scale
        
      MigsOrg : env_local_scale
        
      MigsOrg : env_medium
        
      MigsOrg : estimated_size
        
      MigsOrg : experimental_factor
        
      MigsOrg : extrachrom_elements
        
      MigsOrg : feat_pred
        
      MigsOrg : geo_loc_name
        
      MigsOrg : isol_growth_condt
        
      MigsOrg : lat_lon
        
      MigsOrg : lib_layout
        
          MigsOrg --|> LIB_LAYOUT_ENUM : lib_layout
        
      MigsOrg : lib_reads_seqd
      ...
      MigsOrg : neg_cont_type
        
          MigsOrg --|> NEG_CONT_TYPE_ENUM : neg_cont_type
        
      MigsOrg : nucl_acid_amp
        
      MigsOrg : nucl_acid_ext
        
      MigsOrg : number_contig
        
      MigsOrg : pos_cont_type
        
      MigsOrg : project_name
        
      MigsOrg : ref_biomaterial
        
      MigsOrg : ref_db
        
      MigsOrg : samp_collect_device
        
      MigsOrg : samp_collect_method
        
      MigsOrg : samp_mat_process
        
      MigsOrg : samp_name
        
      MigsOrg : samp_size
        
      MigsOrg : samp_taxon_id
        
      MigsOrg : samp_vol_we_dna_ext
        
      MigsOrg : seq_meth
        
      MigsOrg : sim_search_meth
        
      MigsOrg : sop
        
      MigsOrg : source_mat_id
        
      MigsOrg : subspecf_gen_lin
        
      MigsOrg : tax_class
        
      MigsOrg : tax_ident
        
          MigsOrg --|> TAX_IDENT_ENUM : tax_ident
...
| ---  | ---  |
| self | mixs_6_2_proposal:MigsOrg |
| native | mixs_6_2_proposal:MigsOrg |

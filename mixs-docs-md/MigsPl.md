...
URI: [mixs_6_2_proposal:MigsPl](https://turbomam.github.io/mixs-envo-struct-knowl-extraction/MigsPl)
...
```mermaid
 classDiagram
    class MigsPl
      ...
      MigsPl : assembly_name
        
      MigsPl : assembly_qual
        
      MigsPl : assembly_software
        
      MigsPl : associated_resource
        
      MigsPl : collection_date
        
      MigsPl : compl_score
        
      MigsPl : compl_software
        
      MigsPl : depth
        
      MigsPl : elev
        
      MigsPl : encoded_traits
        
      MigsPl : env_broad_scale
        
      MigsPl : env_local_scale
        
      MigsPl : env_medium
        
      MigsPl : estimated_size
        
      MigsPl : experimental_factor
        
      MigsPl : feat_pred
        
      MigsPl : geo_loc_name
        
      MigsPl : host_spec_range
        
      MigsPl : isol_growth_condt
        
      MigsPl : lat_lon
        
      MigsPl : lib_layout
        
          MigsPl --|> LIB_LAYOUT_ENUM : lib_layout
        
      MigsPl : lib_reads_seqd
      ...
      MigsPl : neg_cont_type
        
          MigsPl --|> NEG_CONT_TYPE_ENUM : neg_cont_type
        
      MigsPl : nucl_acid_amp
        
      MigsPl : nucl_acid_ext
        
      MigsPl : number_contig
        
      MigsPl : pos_cont_type
        
      MigsPl : project_name
        
      MigsPl : propagation
        
      MigsPl : ref_biomaterial
        
      MigsPl : ref_db
        
      MigsPl : samp_collect_device
        
      MigsPl : samp_collect_method
        
      MigsPl : samp_mat_process
        
      MigsPl : samp_name
        
      MigsPl : samp_size
        
      MigsPl : samp_taxon_id
        
      MigsPl : samp_vol_we_dna_ext
        
      MigsPl : seq_meth
        
      MigsPl : sim_search_meth
        
      MigsPl : sop
        
      MigsPl : source_mat_id
        
      MigsPl : specific_host
        
      MigsPl : subspecf_gen_lin
        
      MigsPl : tax_class
        
      MigsPl : tax_ident
        
          MigsPl --|> TAX_IDENT_ENUM : tax_ident
...
| ---  | ---  |
| self | mixs_6_2_proposal:MigsPl |
| native | mixs_6_2_proposal:MigsPl |

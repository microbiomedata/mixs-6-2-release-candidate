...
squeaky-clean: clean
	@for dir in conflict-reports downloads extracted-data generated-schema GSC-excel-harmonized-repaired \
		other-reports schemasheets-to-usage text-mining-results schema-derivatives converted-data \
		mixs-docs-md ; do \
		rm -rf $$dir/*; \
		mkdir -p $$dir; \
		touch $$dir/.gitkeep; \
